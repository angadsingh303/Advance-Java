...
import com.angad.talentfinder.users.listeners.SessionCheckListener;
...
public class WelcomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		int pinCode = (Integer)session.getAttribute("pinCode");
		//String userid = request.getParameter("userid");
		//int pinCode = Integer.parseInt(request.getParameter("pin"));
		//int pinCode = (Integer)request.getAttribute("pin");
		out.println("<html><body><h1>Welcome " +userid+" Pin Code "+pinCode+"</h1></body></html>");
		out.close();
		}
	}	
}
*/
			...
			+userRoleDTO.getUserid()+" Role "+userRoleDTO.getRole()+"Count is "+counter+"Toll free no is "+phoneNo+"</h2>"; 
